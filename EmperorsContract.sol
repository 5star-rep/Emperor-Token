...
contract EMPERORS is Context, IBEP20, Ownable {
    ...
    mapping (uint256 => address) public _isOwner;

    mapping (address => uint256) public _registerID;
    ...
    constructor(IERC721 emperor) public {
        ...
        _mintAmount = 1000000000000000000;
        _registerCost = 200000000000000000000;
    ...
    */
    ...
    function register(uint256 tokenId) public {
        _registerID[msg.sender] = tokenId;
        _isOwner[tokenId] = msg.sender;
        _isRegistered[msg.sender] = true;
        _emperor.transferFrom(msg.sender, address(this), tokenId);
     ...
     */
    function Unregister(uint256 tokenId) public {
        require(msg.sender == _isOwner[tokenId], "Caller not owner tokenId");
        _registerID[msg.sender] = 0;
        _isOwner[tokenId] = address(0);
        _isRegistered[msg.sender] = false;
        _emperor.transferFrom(address(this), msg.sender, tokenId);
